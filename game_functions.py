...
def check_events(ai_settings, screen, ship, bullets):
    """ Responde a eventos (mouse, teclado) """
...
def update_screen(ai_settings, screen, ship, aliens, bullets):
    """ Atualiza as imagens e alterna para a próxima tela """
...
def fire_bullet (ai_settings, screen, ship, bullets):
    """ Dipara um projétil se o limite ainda não foi alcançado"""
...
def update_bullets(aliens, bullets):
    """ Atualiza a posição dos projéteis e deleta dos antigos """
...
def get_number_aliens_x(ai_settings, alien_width):
    # O espaçamento entre eles é igual à largura de um
...
def create_fleet(ai_settings, screen, ship, aliens):
    ...
    # Cria um alienígena e calcula o número de aliens em uma linha
    alien = Alien(ai_settings, screen)
    number_aliens_x = get_number_aliens_x(ai_settings, alien.rect.width)
    number_rows = get_number_rows(ai_settings, ship.rect.height, alien.rect.height)

    # cria a primeira linha da frota
...
def check_fleet_edges(ai_settings, aliens):
    """ Responde se algum alienígena alcançou uma borda. """
